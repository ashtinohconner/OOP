...
public class LibraryGeneric<Type> 
{
  ...
  public ArrayList<LibraryBookGeneric<Type>> lookup(Type holder) {
    // FILL IN -- do not return null
	  ...
	  ArrayList<LibraryBookGeneric<Type>> BookBorrowed = new ArrayList<LibraryBookGeneric<Type>>(bookCount);
	  for(LibraryBookGeneric<Type> b : library)
	  {
		  if(holder.equals(b.getHolder()))
		  {
  ...
  public boolean checkout(long isbn, Type holder, int month, int day, int year) {
    // FILL IN -- do not return false unless appropriat
	  ...
	  for(LibraryBookGeneric<Type> b : library)
	  {
		  if(b.getIsbn() == isbn)
		  {
			  b.holder = holder;
			  b.checkedOut();
			  b.dueDate = new GregorianCalendar(year, month, day);
			  isCheckedOut = true;
		  }
	  }
	return isCheckedOut;
  ...
  public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day,
      int year) {
    // FILL IN -- do not return null
	  GregorianCalendar dueTime = new GregorianCalendar (year, month, day);
	  
	  //creating an array for overdue books
	  ArrayList<LibraryBookGeneric<Type>> checkedOutList = new ArrayList<LibraryBookGeneric<Type>>();
	  //putting overdue books into the overdue list
	  for(LibraryBookGeneric<Type> b : library)
	  {
	  ...
	  for(LibraryBookGeneric<Type> b : checkedOutList)
	  {
		 
		 if( dueTime.before(b.getDueDate()))
			  overdueList.add(b);
 ...
 /**
  ...
  protected class OrderByDueDate implements Comparator<LibraryBookGeneric<Type>> 
  {
    ...
    // FILL IN
	public String toString(LibraryBookGeneric<Type> lib)
	{		
		return 	lib.getIsbn() + " " + lib.getTitle() + " " + lib.getAuthor() + " ";
	}
